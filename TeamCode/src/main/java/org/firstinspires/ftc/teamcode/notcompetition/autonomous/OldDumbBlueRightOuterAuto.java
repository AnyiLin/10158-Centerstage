...
@Autonomous(name = "Old Dumb Blue Right Outer Auto", group = "Not Comp Autonomous")
public class OldDumbBlueRightOuterAuto extends OpMode {
    ...
    private Pose2d startPose = new Pose2d(-36,72-9, Math.toRadians(270));
