...
public class RobotConstants {
    ...
    RIGHT_OUTTAKE_OUT_POSITION = 1-LEFT_OUTTAKE_OUT_POSITION,
    LEFT_OUTTAKE_IN_POSITION= 0,
    RIGHT_OUTTAKE_IN_POSITION = 1-LEFT_OUTTAKE_IN_POSITION,
    LEFT_OUTTAKE_AVOID_POSITION = 0,
    RIGHT_OUTTAKE_AVOID_POSITION = 1-LEFT_OUTTAKE_AVOID_POSITION,
