...
@Autonomous(name = "Old Dumb Red Right Outer Auto", group = "Not Comp Autonomous")
public class OldDumbRedRightOuterAuto extends OpMode {
    ...
    public void buildTrajectories() {
        ...
        scoreSpikeMark = drive.trajectorySequenceBuilder(startPose)
                ...
                .UNSTABLE_addTemporalMarkerOffset(-0.1, ()-> requestOpModeStop())
                /*
