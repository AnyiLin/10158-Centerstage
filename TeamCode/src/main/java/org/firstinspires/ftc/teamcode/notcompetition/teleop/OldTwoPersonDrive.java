...
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.BOTTOM_LINE_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.CLAW_CLOSE_WAIT;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.CLAW_GRAB_WAIT;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.CLAW_LIFT_WAIT;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.DRIVETRAIN_CURRENT_ADJUST_FACTOR;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.DRIVETRAIN_CURRENT_LIMIT;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.FINE_ADJUST_LIFT_CHANGE;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.INNER_CLAW_CLOSE_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.INNER_CLAW_OPEN_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.INTAKE_BURST_TIME;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.INTAKE_CHANGE;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.INTAKE_DEGREES_TO_SERVO;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.INTAKE_EDGE_CASE_COLLIDE_WAIT;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.INTAKE_FULL_OUT_WAIT;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.INTAKE_IN_WAIT;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.INTAKE_OBSTACLE_IN_WAIT;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.INTAKE_OBSTACLE_OUT_RETRACT_WAIT;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.INTAKE_OBSTACLE_OUT_WAIT;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.INTAKE_VELOCITY;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.LEFT_AUTONOMOUS_OUTTAKE_GRAB_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.LEFT_INTAKE_DROP_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.LEFT_INTAKE_IN_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.LEFT_INTAKE_MIDDLE_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.LEFT_INTAKE_OUT_PAUSE_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.LEFT_INTAKE_OUT_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.LEFT_OUTTAKE_AVOID_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.LEFT_OUTTAKE_GRAB_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.LEFT_OUTTAKE_IN_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.LEFT_OUTTAKE_OUT_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.LEFT_OUTTAKE_PRESET_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.LIFT_GO_WAIT;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.LIFT_GRAB_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.LIFT_GRAB_TIMEOUT;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.LIFT_GRAB_TOLERANCE;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.LIFT_GRAB_VELOCITY_LIMIT;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.LIFT_MAX;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.LIFT_TOLERANCE;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.LIFT_VELOCITY;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.MIDDLE_LINE_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.OUTER_CLAW_CLOSE_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.OUTER_CLAW_OPEN_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.OUTTAKE_AUTONOMOUS_PICK_UP_DEGREES_PER_SECOND;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.OUTTAKE_CHANGE;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.OUTTAKE_DEGREES_TO_SERVO;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.OUTTAKE_FINE_ADJUST_DEAD_ZONE;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.OUTTAKE_OBSTACLE_FOLD_IN_WAIT;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.OUTTAKE_PICK_UP_DEGREES_PER_SECOND;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.PLANE_LAUNCHER_HOLD;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.PLANE_LAUNCHER_LAUNCH;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.PRESET_TIMEOUT;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.REGULAR_LIFT_CHANGE;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.RESET_PIXEL_DROP_WAIT;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.RIGHT_AUTONOMOUS_OUTTAKE_GRAB_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.RIGHT_INTAKE_DROP_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.RIGHT_INTAKE_IN_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.RIGHT_INTAKE_MIDDLE_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.RIGHT_INTAKE_OFFSET;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.RIGHT_INTAKE_OUT_PAUSE_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.RIGHT_INTAKE_OUT_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.RIGHT_OUTTAKE_AVOID_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.RIGHT_OUTTAKE_GRAB_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.RIGHT_OUTTAKE_IN_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.RIGHT_OUTTAKE_OFFSET;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.RIGHT_OUTTAKE_OUT_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.RIGHT_OUTTAKE_PRESET_POSITION;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.SLIDE_DELAY;
import static org.firstinspires.ftc.teamcode.util.OldRobotConstants.TOP_LINE_POSITION;
...
public class OldTwoPersonDrive extends LinearOpMode {
    ...
    public OldTwoPersonDrive() {
    }

    public OldTwoPersonDrive(boolean setAuto) {
        autonomous = setAuto;
    }
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            if (!startSlideReset && System.currentTimeMillis()-initStartTime>1500) {
                startSlideReset = true;
                asyncTimers();
            }
