...
public class LM5_RedAuto extends OpMode {
    ...
    public void setBackdropGoalPose() {
        switch (navigation) {
            case "left":
                ...
                EXTENSION_SPIKE_MARK_POSITION = 420;
                initialBackdropGoalPose = new Pose2d(redLeftBackdrop.getX() + 2, redLeftBackdrop.getY()-ROBOT_BACK_LENGTH, Math.PI * 1.5);
                break;
            case "middle":
                ...
                initialBackdropGoalPose = new Pose2d(redMiddleBackdrop.getX() + 4.75, redMiddleBackdrop.getY()-ROBOT_BACK_LENGTH,Math.PI * 1.5);
                break;
            case "right":
                ...
                initialBackdropGoalPose = new Pose2d(redRightBackdrop.getX() + 1.25, redRightBackdrop.getY()-ROBOT_BACK_LENGTH, Math.PI * 1.5);
                break;
        }
    }
    ...
    public void buildPaths() {
        ...
        getOutOfWay = new Path(new BezierCurve(new Point(initialBackdropGoalPose), new Point(initialBackdropGoalPose.getX(), 106, Point.CARTESIAN), new Point(86, 120, Point.CARTESIAN)));
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 7: // once the robot is nice and folded up, request stop
